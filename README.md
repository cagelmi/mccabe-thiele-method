...
The development of this Python GUI was assisted by Google's Gemini 2.5 Pro Preview (May 6, 2024, model), which helped in translating the logic from a MATLAB version created by Claudio Gelmi.
